const PrinterSetupIssue = () => {
  return (
    <main className="bg-white text-[#701a75] min-h-screen flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8">
      <h2 className="text-4xl mb-2 font-semibold">Printer Setup Issue</h2>
          ...
          ({ step, description, imageUrl, adsId }, index) => (
            ...
            >
              ...
              <div className="sm:w-1/2 sm:pl-8 mt-4 sm:mt-0">
                <h2 className="text-lg font-semibold mb-2">Step - {step}</h2>
